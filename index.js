...
io.on("connection", (client) => {
  ...
  client.on("messages", (data) => {
    ...
    client.emit(
      "broad",
      "<div style='margin: 10px 0;'><span><span class='pfplink' onclick='window.location = \"/profile?user=" + encodeURIComponent(data.user.disName) + "@" + encodeURIComponent(data.user.ugn) + "&bio=" + encodeURIComponent(data.user.bio) + "\"'>" +
      data.user.disName +
      "@" +
      data.user.ugn +
